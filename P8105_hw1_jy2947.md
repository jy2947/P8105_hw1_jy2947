...
```
    ...
    ##      <dbl>   <dbl> <lgl>                <dbl> <fct> 
    ##  1  0.452  -0.855  FALSE                    0 FALSE 
    ##  2 -0.0220 -0.785  FALSE                    0 FALSE 
    ##  3  0.988   1.81   TRUE                     1 TRUE  
    ##  4 -0.398   2.35   TRUE                     1 TRUE  
    ##  5 -1.44    1.33   FALSE                    0 FALSE 
    ##  6  0.0535 -0.141  FALSE                    0 FALSE 
    ##  7  1.21   -0.859  TRUE                     1 TRUE  
    ##  8  1.80    0.0188 TRUE                     1 TRUE  
    ##  9  0.499  -1.36   FALSE                    0 FALSE 
    ## 10 -2.22   -1.10   FALSE                    0 FALSE 
    ## # ... with 990 more rows
...
The size of the dataset is 3.389610^{4}. The mean of x is -0.0188729. The median of x is -0.0746525. The proportion of cases for which the logical vector is `TRUE` is 0.486.
